      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <NuxtLink to="/#" class="ml-2 sm:ml-16 md:mr-24">
              <img src="/logo.png" class="h-11" alt="Logo" />
            </NuxtLink>
            <form action="#" method="GET" class="hidden lg:block">
              ...
              <div class="relative mt-1 lg:w-96">
                ...
                <input type="text" name="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full pl-10 p-2.5" placeholder="Search">
              </div>
            </form>
          </div>
          <AdminHeaderMenu />
